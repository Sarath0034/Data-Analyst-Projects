...
| --- | --- |
| SQL | Query-based data analysis projects using relational databases and business questions. |
| Excel | Spreadsheet analysis, cleaning, dashboards, and reporting projects. |
